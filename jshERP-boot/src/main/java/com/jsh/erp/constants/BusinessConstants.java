...
public class BusinessConstants {
    ...
    /**
     * 单据状态 billsStatus '0'未审核 '1'审核 '2'完成采购|销售 '3'部分采购|销售 '4'已发放
     * */
    ...
    public static final String BILLS_STATUS_ISSUED = "4";
    /**
    ...
    /**
     * Role code values stored in jsh_role.value.
     */
    public static final String ROLE_CODE_ADMIN = "ROLE_ADMIN";
    public static final String ROLE_CODE_OFFICE = "ROLE_OFFICE";
    public static final String ROLE_CODE_DEPT = "ROLE_DEPT";
