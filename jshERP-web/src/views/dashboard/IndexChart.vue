<template>
  <div class="page-header-index-wide">
    <a-row :gutter="24">
      <a-col v-if="false" :sm="24" :md="12" :xl="4" :style="{ paddingRight: '0px',marginBottom: '12px' }">
    ...
    <a-row :gutter="24">
      <a-col v-if="false" :sm="24" :md="12" :xl="8" :style="{ paddingRight: '0px',marginBottom: '12px' }">
        ...
        <a-card :bordered="false" :body-style="{padding: '5'}" data-step="7" data-title="服务和版权"
          ...
          <div class="hidden-xs" style="float:right;">
            <a-popover
              ...
              <a-button type="link" v-if="showWeixinSpan()">办公用品管理系统小程序</a-button>
            </a-popover>
            &copy; 2015-2030 {{systemTitle}} V3.6
          </div>
          <span>用于物品、采购、领用申请和库存报表管理</span>
        </a-card>
      </a-col>
    </a-row>
  </div>
