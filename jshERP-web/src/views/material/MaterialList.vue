    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator"  style="margin-top: 5px">
          ...
          <a-button v-if="btnEnableList.indexOf(3)>-1" @click="handleExportXls('物品信息')" icon="download">导出</a-button>
  ...
  export default {
    ...
    methods: {
      ...
      handleImportXls() {
        ...
        let templateName = '物品Excel模板[下载]'
        this.$refs.modalImportForm.initModal(importExcelUrl, templateUrl, templateName);
        this.$refs.modalImportForm.title = "物品导入";
      },
      searchReset() {
        this.queryParam = {
          mpList: getMpListShort(Vue.ls.get('materialPropertyList'))  //扩展属性
